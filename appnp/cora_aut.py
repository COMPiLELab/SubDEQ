...
path = "data_graph"
parser.target_path = path+"/cora-author/node-labels-cora-author.txt"
x = pd.read_pickle(path+"/cora-author/features.pickle").toarray()
hyper = pd.read_csv(path+"/cora-author/hyperedges-cora-author.txt",sep=", ", header=None)
n = x.shape[0]

parser.knownlabels = 0.052
